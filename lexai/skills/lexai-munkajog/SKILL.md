...
Importáld a logikát: `lexai-router/references/risk-levels.md`
...
Használd az `lexai-router/references/output-template.md` sablont.
...
- GDPR/adatvédelmi szempontok (otthoni hozzáférés, VPN) → lásd `lexai-gdpr`
