...
☐ ÁSZF elkészítése → lásd lexai-szerzodes
☐ Adatkezelési tájékoztató → lásd lexai-gdpr
☐ Fogyasztói tájékoztatók → lásd lexai-fogyasztovedelmi
☐ NAV online számla rendszer csatlakozás → lásd lexai-ado
☐ Cookie kezelés (opt-in) → lásd lexai-gdpr
