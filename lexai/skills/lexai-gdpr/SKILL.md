...
- Webshop adatvédelem → **lexai-fogyasztovedelmi** (ÁSZF, elállási jog, cookie + GDPR)
- Munkavállalói adatkezelés → **lexai-munkajog** (munkaviszony, home office adatvédelem)
- DPA szerződés → **lexai-szerzodes** (szerződéskötés, felelősségkorlátozás)
- Szoftver adatvédelem → **lexai-szellemi-tulajdon** (szoftver IP + GDPR)
